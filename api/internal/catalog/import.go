...
func (s *Service) ListImports(ctx context.Context, collectionID string, page, size int) ([]*model.ImportBatch, int, error) {
	return s.dao.ListImportBatches(ctx, strings.TrimSpace(collectionID), page, size)
}
