...
func TestDocumentCommentsFlow(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		t.Assert(createdJSON.Get("comment.avatarUrl").String(), "/media/comment-avatar?format=webp&preset=thumbnail&v=1")
		...
		t.Assert(listedJSON.Get("items.0.avatarUrl").String(), "/media/comment-avatar?format=webp&preset=thumbnail&v=1")
		...
		t.Assert(managedJSON.Get("items.0.avatarUrl").String(), "/media/comment-avatar?format=webp&preset=thumbnail&v=1")
