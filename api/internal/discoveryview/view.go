// Package discoveryview owns Docs' HTTP projection of a Foundation Discovery publication.
package discoveryview
...
func FindArtifact(snapshot discovery.MemoryPublication, name string) ArtifactResult {
	result := ArtifactResult{ContractVersion: snapshot.Manifest.ContractVersion}
