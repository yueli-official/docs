...
Adjusts the hue, saturation, brightness, and/or
offset of the input clip.
...
- **Preserve Luma** (Check-box, Default: off)
  Enable this to preserve the brightness values of the input image after the hue is shifted.
