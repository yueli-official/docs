...
Tints the dark and light regions of the input clip towards given colors. The
dark colors are tinted by the Tint Dark color, and the brighter colors are
tinted by the Tint Lights color.

In the Sapphire Adjust effects submenu.

![Tint](../_static/Tint.jpg)
...
- **Source Saturation** (Default: 1, Range: -2 to 8)
  Scales the chroma saturation of the source. If this is zero you will see only color from the given tint colors.
