...
- **Color2 At Bright** (Default: 0.66, Range: any)
  要替换为 color2 的源亮度值。此值通常应在 color1 和 color3 At Bright 值之间。

- **Color1 At Bright** (Default: 0.33, Range: any)
  要替换为 color1 的源亮度值。此值通常应在 color0 和 color2 At Bright 值之间。
