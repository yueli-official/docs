...
Combines the source clip with a stripe pattern and
then passes them through a colorization process. The Phase Speed parameter causes the
...
- **Stripe Dir** (Default: 45, Range: any)
  The direction of the stripes, in degrees from vertical.

- **Stripe Mag** (Default: 0.5, Range: 0 or greater)
  The magnitude of the stripes. Increase for more cycles of the colors in the stripe direction.
...
- **Source Scale** (Default: 1, Range: 0 or greater)
  Scales the source values but not the added stripes.
