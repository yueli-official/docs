...
使用程序化生成的细胞形状图案在两个输入素材之间执行擦除转场。应对 Wipe Percent 参数设置动画以控制转场速度。增大 Grad Add 参数可使细胞图案的时序在擦除过程中移动到屏幕上。增大 Border Width 参数可在擦除转场边缘绘制边框。
...
- **Frequency** (Default: 6, Range: 0.01 or greater)
  细胞图案的频率。增大可获得更多更小的元素，减小可获得更少更大的元素。

- **Rel Width** (Default: 1, Range: 0.1 or greater)
  细胞的相对水平尺寸。增大可获得更宽的细胞，减小可获得更高的细胞。
