...
使用不断增大或缩小的矩形在两个输入素材之间执行擦除转场。应对 Wipe Percent 参数设置动画以控制转场速度。增大 Border Width 参数可在擦除转场边缘绘制边框。
...
- **Wipe Direction** (Popup menu, Default: Rect In)
  矩形擦除的方向。
  - **Rect In**: 矩形包含第一个图像并向内缩小。
  - **Rect Out**: 矩形包含第二个图像并向外扩大。
...
- **Rel Width** (Default: 1.25, Range: 0.02 or greater)
  矩形的相对宽度。增大可使其更宽，减小可使其更窄。

- **Center** (X & Y, Default: [0 0], Range: any)
  矩形中心在屏幕坐标中相对于画面中心的位置。可以通过启用和移动 Center Widget 来设置此参数。请注意，移动矩形中心也会导致矩形大小改变，以使 Wipe Amt 的当前值保持正确。
