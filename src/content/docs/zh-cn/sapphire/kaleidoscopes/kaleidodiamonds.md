---
title: Kaleido:Diamonds
---

## S_Kaleido:Diamonds

将源片段反射成菱形图案。"Inside"参数在源图像被反射到图案之前对其进行变换。Center 和 Z Dist 变换整个结果（包括反射图案），Rotate 仅影响反射的"镜面"。

在 Sapphire Stylize 效果子菜单中。
在 S_Kaleido 插件中。

![Kaleido:Diamonds](../_static/KaleidoDiamonds.jpg)
