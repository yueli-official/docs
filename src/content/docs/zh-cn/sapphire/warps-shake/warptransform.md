...
通过线性变换的组合对源素材进行变形，包括缩放、剪切、缩放、旋转和平移。
...
- **Z Dist** (Default: 1, Range: 0.001 or greater)
  缩放图像的"距离"。大于 1.0 的值使其更远更小。小于 1.0 的值使图像更近更大。请注意，Scale X 和 Y 也可以缩放图像大小，但方式相反且分别在每个轴上。

- **Rotate** (Default: 0, Range: any)
  按指定角度（以度为单位）旋转源图像。

- **Swivel** (Default: 0, Range: any)
  在 3D 中围绕垂直轴向左或向右旋转图像。

- **Tilt** (Default: 0, Range: any)
  在 3D 中围绕水平轴向上或向下旋转图像。可以同时使用 Swivel 和 Tilt 围绕任意对角轴旋转。

- **Perspective Amount** (Default: 1, Range: 0.25 to 4)
  控制应用 Swivel 和 Tilt 时的镜头长焦量。增大以获得更强的 3D 透视效果。
