...
使用两组重叠的气泡图案对源素材进行变形。可用于创建热扩散或水下类型的效果。Shift Speed 参数使噪波图案随时间自动平移。调整 Amplitude 和 Frequency 参数以获得不同类型的变形效果。
...
*4,
*Range:
*0.01 or greater.第一组气泡的频率。

A Octaves:
*Integer, Default:
*1,
*Range:
*1 to 10.第一组气泡的噪波倍频程数。

A Seed:
*Default:
*0.23,
*Range:
*0 or greater.第一组气泡的随机数生成器种子。
...
*4,
*Range:
*0.01 or greater.第二组气泡的频率。

B Octaves:
*Integer, Default:
*1,
*Range:
*1 to 10.第二组气泡的噪波倍频程数。

B Seed:
*Default:
*0.34,
*Range:
*0 or greater.第二组气泡的随机数生成器种子。
