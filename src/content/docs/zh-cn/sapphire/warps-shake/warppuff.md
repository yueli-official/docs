...
Warps the source clip based on its gradient. By default, brighter areas are
puffed out and darker areas are shrunk. This is similar to applying
Distort effect to an image using itself as the lens.
