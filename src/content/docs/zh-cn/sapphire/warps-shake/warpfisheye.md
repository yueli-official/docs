...
如同通过鱼眼镜头观看一样扩展源素材的中心。调整 Amount 参数以获得更多或更少的变形。关闭 Wrap 选项可在输入素材边界外显示透明而非反射副本。
