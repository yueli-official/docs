...
Adjust the Amount parameter to give more or less distortion. Turn off the
Wrap options to give transparency beyond the borders of the input clip
instead of reflected copies.

In the Sapphire Distort effects submenu.

![WarpFishEye](../_static/WarpFishEye.jpg)
...
- **Center** (X & Y, Default: [0 0], Range: any)
  The center of the fish-eye warping function, in screen coordinates relative to the center of the frame.
...
- **Rotate** (Default: 0, Range: any)
  Rotates the result about the center location by this many degrees.
