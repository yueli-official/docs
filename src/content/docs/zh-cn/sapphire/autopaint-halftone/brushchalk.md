...
通过叠加不同大小和方向的笔触来模拟粉笔画效果。此效果可与以下画笔之一配合使用：毡尖笔、飞溅、水彩、点画、铅笔、粉彩、海绵、泼墨、圆形或方块。此外，还提供了调整形状、大小、方向、密度、光照和阴影的控制选项。
...
- **Chalkiness** (Default: 0.6, Range: 0 to 1)
  缩放笔刷的细节，从稀疏绘制的粗糙笔触到完全绘制的平滑笔触。

- **Blending** (Default: 0.6, Range: 0 to 1)
  缩放单个笔刷的透明度，使叠层笔刷看起来更融合。
