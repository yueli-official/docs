...
![DefocusPrism](../_static/DefocusPrism.jpg)
...
- **Chroma Sep** (Default: 0.3, Range: -1 to 1)
  三个颜色通道环之间的分离量。

- **Chroma Ringthick** (Default: 0.3, Range: 0.01 or greater)
  三个颜色通道环各自的厚度。
...
- **Show Defocus Width** (Check-box, Default: on)
  打开或关闭用于调整 Defocus Width 参数的屏幕用户界面。此参数仅在 AE 和 Premiere 中出现，这些软件支持屏幕控件。
