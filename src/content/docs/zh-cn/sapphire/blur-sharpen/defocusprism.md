...
Defocuses the color channels of the source clip into
rings of different widths.
...
- **Chroma Sep** (Default: 0.3, Range: -1 to 1)
  The amount of separation between the three color channel rings.

- **Chroma Ringthick** (Default: 0.3, Range: 0.01 or greater)
  The thickness of each of the three color channel rings.
