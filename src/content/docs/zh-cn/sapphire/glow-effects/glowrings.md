...
Generates glows of colored rings around the areas of
the source clip that are brighter than the given threshold.
Raise the threshold parameter to produce glows
in fewer areas. Adjust the Width and Thickness RGB parameters to make glows with
different color patterns, and adjust the Width XY parameters to make
horizontal or vertical glows.

In the Sapphire Lighting effects submenu.

![GlowRings](../_static/GlowRings.jpg)
...
- **Width Red** (Default: 0.5, Range: 0 or greater)
...
- **Width Green** (Default: 0.75, Range: 0 or greater)
...
- **Thickness Red** (Default: 0.5, Range: 0 to 1)
  Scales the thickness of the red region.

- **Thickness Green** (Default: 0.5, Range: 0 to 1)
  Scales the thickness of the green region.

- **Thickness Blue** (Default: 0.5, Range: 0 to 1)
  Scales the thickness of the blue region.
