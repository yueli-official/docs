...
沿源素材的梯度方向生成径向彩色光环线条。提高阈值参数可以减少产生辉光的区域。调整 Width、Frequency、Phase 和 Twist 参数可以制作不同光环图案的辉光。
...
- **Glow Saturation** (Default: 1, Range: any)
  缩放辉光颜色的饱和度。增大可获得更强烈的颜色。设为 0 可获得单色效果。
...
- **Phase Speed** (Default: 1, Range: any)
  如果非零，颜色相位将以此速度自动设置动画，使颜色图案随时间流动。
