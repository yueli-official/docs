...
and clearing your image cache before rendering may sometimes be
necessary.
...
- **Lens**: Defaults to None. Distorts the previous frames using the brightness values of this input clip.
