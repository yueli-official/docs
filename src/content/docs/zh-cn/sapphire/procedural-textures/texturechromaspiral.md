---
title: TextureChromaSpiral
---

## S_TextureChromaSpiral

通过对程序化生成的噪波纹理应用 WarpChroma 效果来创建抽象纹理。

在 Sapphire Render 效果子菜单中。

![TextureChromaSpiral](../_static/TextureChromaSpiral.jpg)
