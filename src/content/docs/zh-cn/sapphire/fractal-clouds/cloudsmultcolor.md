---
title: CloudsMultColor
---

## S_CloudsMultColor

生成类似 S_Clouds 的程序化噪波纹理，并使用额外的颜色噪波纹理为其着色。Shift Speed 参数可使纹理随时间自动平移。

在 Sapphire Render 效果子菜单中。

![CloudsMultColor](../_static/CloudsMultColor.jpg)
