---
title: EdgeDetectDouble
---

## S_EdgeDetectDouble

执行两次边缘检测操作，产生双线边缘效果。增大 Edge Smooth 参数可获得更粗的边缘。

在 Sapphire Stylize 效果子菜单中。

![EdgeDetectDouble](../_static/EdgeDetectDouble.jpg)
...
- **Edge Smooth1** (Default: 0.088, Range: 0 or greater)
  增大此值可使第一次边缘检测的边缘更平滑。
...
- **Show** (Popup menu, Default: Result)
  选择输出选项。
  - **Edges1 Only**: 仅显示第一次边缘检测的结果。这对于在不执行第二次边缘检测的情况下调整 Edge1 参数非常有用。
  - **Result**: 显示双重边缘检测的结果。
