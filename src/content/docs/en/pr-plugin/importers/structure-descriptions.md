...
Selector: [imRetargetAccelerator](../selector-descriptions#imretargetaccelerator)
...
Selector: [imAnalysis](../selector-descriptions#imanalysis)
...
Selector: [imCreateAsyncImporter](../selector-descriptions#imcreateasyncimporter)
...
Selector: [imGetInfo8](../selector-descriptions#imgetinfo8) (member of [imFileInfoRec8](#imfileinforec8))
...
Selector: [imCalcSize8](../selector-descriptions#imcalcsize8)
...
Selector: [imCheckTrim8](../selector-descriptions#imchecktrim8)
...
Selector: [imSelectClipFrameDescriptor](../selector-descriptions#imselectclipframedescriptor)
...
Selector: [imCompleteAsyncClosedCaptionScan](../selector-descriptions#imcompleteasyncclosedcaptionscan)
...
Selector: [imGetIndColorProfile](../selector-descriptions#imgetindcolorprofile)
...
Selector: [imCopyFile](../selector-descriptions#imcopyfile)
...
Selector: [imDataRateAnalysis](../selector-descriptions#imdatarateanalysis)
...
Selector: [imDeferredProcessing](../selector-descriptions#imdeferredprocessing)
...
Selector: [imDeleteFile](../selector-descriptions#imdeletefile)
...
Selector: [imGetFileAttributes](../selector-descriptions#imgetfileattributes)
...
Selector: [imGetInfo8](../selector-descriptions#imgetinfo8)
...
| `sessionPluginID` | This ID should be used in the [File Registration Suite](../../universals/sweetpea-suites#file-registration-suite) for registering external files (such as textures, logos, etc) that are used by an importer instance but do not appear as footage in the Project Window. |
...
Selector: [imOpenFile8](../selector-descriptions#imopenfile8)
...
| `inImporterID` | Can be used as the ID for calls in the [PPix Cache Suite](../../universals/sweetpea-suites#ppix-cache-suite). |
...
Selector: [imGetSourceVideo](../selector-descriptions#imgetsourcevideo) (member of [imSourceVideoRec](#imsourcevideorec))
...
Selector: [imGetAudioChannelLayout](../selector-descriptions#imgetaudiochannellayout)
...
| | Labels are defined in the [Audio Suite](../../universals/sweetpea-suites#audio-suite). |

---

## imGetNextClosedCaptionRec

Selector: [imGetNextClosedCaption](../selector-descriptions#imgetnextclosedcaption)
...
Selector: [imGetPrefs8](../selector-descriptions#imgetprefs8)
...
| `sessionPluginID` | This ID should be used in the [File Registration Suite](../../universals/sweetpea-suites#file-registration-suite) for registering external files (such as textures, logos, etc) that are used by a importer instance but do not appear as footage in the Project Window. |
...
| Member | Description |
| --- | --- |
| `importerID` | `Can` be used as the ID for calls in the [PPix Cache Suite](../../universals/sweetpea-suites#ppix-cache-suite). |
...
| | This allows a player to optionally use the [RollCrawl Suite](../../universals/sweetpea-suites#rollcrawl-suite) to get sections of this title for real-time playback. |
...
Selector: [imImportAudio7](../selector-descriptions#imimportaudio7)
...
Selector: [imImportImage](../selector-descriptions#imimportimage)
...
Selector: [imInit](../selector-descriptions#iminit)
...
Selector: [imGetIndFormat](../selector-descriptions#imgetindformat)
...
Selector: [imGetIndPixelFormat](../selector-descriptions#imgetindpixelformat)
...
Selector: [imInitiateAsyncClosedCaptionScan](../selector-descriptions#iminitiateasyncclosedcaptionscan)
...
Selector: [imGetMetaData](../selector-descriptions#imgetmetadata) and [imSetMetaData](../selector-descriptions#imsetmetadata)
...
Selector: [imGetPeakAudio](../selector-descriptions#imgetpeakaudio)
...
Selector: [imGetPreferredFrameSize](../selector-descriptions#imgetpreferredframesize)
...
Selector: [imQueryContentState](../selector-descriptions#imquerycontentstate)
...
Selector: [imQueryDestinationPath](../selector-descriptions#imquerydestinationpath)
...
Selector: [imQueryInputFileList](../selector-descriptions#imqueryinputfilelist)
...
| | Use the [String Suite](../../universals/sweetpea-suites#string-suite) to fill the array with PrSDKStrings with the actual paths. |

---

## imQueryStreamLabelRec

Selector: [imQueryStreamLabel](../selector-descriptions#imquerystreamlabel)
...
| `outStreamLabel` | The stream label, allocated using the [String Suite](../../universals/sweetpea-suites#string-suite). |

---

## imSaveFileRec8

Selector: [imSaveFile8](../selector-descriptions#imsavefile8)
...
Selector: [imGetSourceVideo](../selector-descriptions#imgetsourcevideo), `aiInitiateAsyncRead`, `aiGetFrame`
...
Selector: [imGetSubTypeNames](../selector-descriptions#imgetsubtypenames)
...
Selector: [imGetTimeInfo8](../selector-descriptions#imgettimeinfo8) and [imSetTimeInfo8](../selector-descriptions#imsettimeinfo8)
...
Selector: [imTrimFile8](../selector-descriptions#imtrimfile8)
...
Selector: [imGetIndColorSpace](../selector-descriptions#imgetindcolorspace)
