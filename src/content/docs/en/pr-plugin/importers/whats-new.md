...
As a convenience, when a file is opened, an importer can tell Premiere Pro how much memory to reserve for the importer's usage, rather than calling ReserveMemory in the [Memory Manager Suite](../../universals/sweetpea-suites#memory-manager-suite). The importer should pass back this value in `imFileOpenRec8.outExtraMemoryUsage`.
