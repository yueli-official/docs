...
The current number of ticks per second must be retrieved using the callback in the [Time Suite](../sweetpea-suites#time-suite). This rate is guaranteed to be constant for the duration of the application's run-time.
