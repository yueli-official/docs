...
[neighbourcount](/en/houdini-vex/geometry/neighbourcount "Returns the number of points that are connected to the specified point.") and [neighbour](/en/houdini-vex/geometry/neighbour "Returns the point number of the next point connected to a given point."). The array contains the numbers
