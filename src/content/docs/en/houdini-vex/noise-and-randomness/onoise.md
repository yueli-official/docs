...
These functions are similar to [wnoise](/en/houdini-vex/noise-and-randomness/wnoise "Generates Worley (cellular) noise.") and
[vnoise](/en/houdini-vex/noise-and-randomness/vnoise "Generates Voronoi (cellular) noise."). However, they are marginally less efficient in
