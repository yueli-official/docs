...
To look up a point by its `name` attribute value, use [nametopoint](/en/houdini-vex/attributes-and-intrinsics/nametopoint "Finds a point by its name attribute."). To look up a point by an arbitrary string or int attribute value, use [findattribval](/en/houdini-vex/attributes-and-intrinsics/findattribval "Finds a primitive/point/vertex that has a certain attribute value.").
