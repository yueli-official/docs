...
[pcexport](/en/houdini-vex/point-clouds-and-3d-images/pcexport "Writes data to a point cloud inside a pciterate or a pcunshaded loop.").

While this function is similar to [pcopen](/en/houdini-vex/point-clouds-and-3d-images/pcopen "Returns a handle to a point cloud file."), the major difference is the points that it queues up may be aggregates of entire groups of points. In
...
As in [pcopen](/en/houdini-vex/point-clouds-and-3d-images/pcopen "Returns a handle to a point cloud file."), P specifies the query origin and Pchannel
...
`distance` mode is provided for compatibility with [pcopen](/en/houdini-vex/point-clouds-and-3d-images/pcopen "Returns a handle to a point cloud file.") and does
...
accepted - identical to the radius passed to [pcopen](/en/houdini-vex/point-clouds-and-3d-images/pcopen "Returns a handle to a point cloud file."). For example,
