...
order: 3
---
To specify the curve using unevenly spaced keys, use [ckspline](/en/houdini-vex/interpolation/ckspline "Samples a Catmull-Rom (Cardinal) spline defined by position/value keys.").
