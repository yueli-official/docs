...
order: 1
---
This function does bilinear interpolation of the pixel values. To get unfiltered pixel values, use [rawcolormap](/en/houdini-vex/texturing/rawcolormap "Looks up an unfiltered color from a texture file.").
