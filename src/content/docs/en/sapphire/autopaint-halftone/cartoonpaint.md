...
Auto-generates a version of the source clip with a
cartoon paint-brushed look. Finds the edges in the image and draws new outlines
for those edges. Replaces the colors of the areas between the edges
with paint brush shapes.
...
*50,
*Range:
*0.3 or greater.The density of brush strokes in the frame. Increase
for smaller strokes.
...
*2,
*Range:
*any.Determines the length of the brush strokes along
...
*0.2,
*Range:
*0 or greater.Increase to smooth out the directions of the strokes
...
*0,
*Range:
*0 or greater.Blurs the source by this amount before generating
