...
Breaks the image into rectangle shaped tiles and transforms the image within
each shape, to create a fly's eye view effect. The 'Inside' parameters
transform the Source image before it is tiled into the pattern, and the
'Tile' parameters transform the entire fly's eye pattern.

In the Sapphire Stylize effects submenu.

![FlysEyeRect](../_static/FlysEyeRect.jpg)
