...
Warps the chrominance of the source input by different
amounts using the gradient of the Lens input clip. This can
generate optical glass-like effects as if the source clip were being
viewed through an arbitrarily shaped or textured prism. It is best
demonstrated when the lens image contains just a few simple bold
shapes.
