...
Generates a field of sparkling Glint effects with varying colors. Adjust the
Frequency, Density, and Size parameters for different types of sparkling
patterns. Use the Matte input to only generate sparkles in specified
areas.
...
- **Color Variation** (Default: 1, Range: 0 or greater)
  Scales the saturation of the sparkles. Increase for more intense colors, decrease for more subtle colors.
