...
Generates an image of procedural cellular shapes. The Rotate Speed parameter
causes the cell centers to rotate within each cell over time.
...
- **Rotate Centers** (Default: 0, Range: any)
  Rotation offset of the cell centers, in degrees.

- **Rotate Speed** (Default: 90, Range: any)
  The speed of cell center rotation, in degrees per second. If non-zero, the cell centers are automatically animated to wiggle at this rate.
