...
- **Threshold** (Default: 0.5, Range: 0 or greater)
  The source brightness value to use as the mid-point of the thresholding. This is often a middle gray around .5.

- **Threshold Add Color** (Default rgb: [0 0 0])
  Raises the thresholds on each color channel using this color. It has no effect when black.

- **Softness** (Default: 0.2, Range: 0.001 to 1)
  The softness of the transition between full off and on. Increase for smoother transitions, decrease for sharper ones.

- **Soft Rel Red** (Default: 1, Range: 0 or greater)
  The relative softness of the red thresholding.
