...
- **Frequency** (Default: 8, Range: 0.01 or greater)
  The frequency of the bubble warping pattern. Increase for smaller bubbles, decrease for larger.

- **Frequency Rel Y** (Default: 1, Range: 0.01 or greater)
  The relative vertical frequency of the bubbles. Decrease for taller bubbles, increase for wider ones.
