...
Twists the source clip into a vortex, about a given Center location. Use the
Vortex Start parameter to adjust the amount of vortexing, and use Angle
Offset to also apply a normal rotation. Vortex Speed can be used to
automatically animate the amount of vortexing.

In the Sapphire Distort effects submenu.

![WarpVortex](../_static/WarpVortex.jpg)
...
- **Inner Radius** (Default: 0.042, Range: 0 or greater)
