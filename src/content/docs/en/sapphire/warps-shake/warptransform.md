...
![WarpTransform](../_static/WarpTransform.jpg)
...
- **Scale** (X & Y, Default: [1 1], Range: any)
  Scales the relative horizontal or vertical size of the source image.

- **Shift** (X & Y, Default: [0 0], Range: any)
  Translates the source image.

- **Z Dist** (Default: 1, Range: 0.001 or greater)
  Scales the 'distance' of the image. Values greater than 1.0 move it farther away and make it smaller. Values less then 1.0 move the image closer and enlarge it. Note that Scale X and Y also scale the size of the image, but in an inverse way and on each axis.

- **Rotate** (Default: 0, Range: any)
  Rotates the source image by the specified angle in degrees.
