...
Generates a procedural noise texture like
S_Clouds and tints the colors using an additional color noise
texture. The Shift Speed parameters cause the texture to automatically
translate over time.
