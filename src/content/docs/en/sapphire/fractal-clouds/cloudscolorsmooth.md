...
Generates a full color clouds texture. Procedural noise texture is
independently generated for each of the red, green, and blue output
channels. The Shift Speed parameters cause the texture to automatically
translate over time.
