---
title: WipeDoubleWedge
---

## S_WipeDoubleWedge

Performs a wipe transition between two input
clips using two wedge shapes. The Wipe Percent parameter should be
...
![WipeDoubleWedge](../_static/WipeDoubleWedge.jpg)
...
- **Wipe Direction** (Popup menu, Default: Wedge In)
  Selects the direction of the motion of the wedges.
  - **Wedge In**: the wedge contains the first image and shrinks inwards.
  - **Wedge Out**: the wedge contains the second image and grows outwards.
...
- **Angle** (Default: 0, Range: any)
  The rotation angle of the wedge shapes in degrees.

- **Pointiness** (Default: 2, Range: 0 or greater)
  The sharpness of the point of the wedges.
