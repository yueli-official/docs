...
using a wedge shape. The Wipe Percent parameter should be
...
![WipeWedge](../_static/WipeWedge.jpg)
...
- **Wipe Direction** (Popup menu, Default: Wedge In)
  Selects the direction of the wedge motion.
...
- **Angle** (Default: 0, Range: any)
  The rotation angle of the wedge shape in degrees.

- **Pointiness** (Default: 2, Range: 0 or greater)
  The sharpness of the point of the wedge.
