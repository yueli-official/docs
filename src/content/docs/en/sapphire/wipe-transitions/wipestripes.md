...
using a series of stripes. The Wipe Percent parameter should be
animated to control the transition speed.
Increase the Grad Add parameter to make the timing of the stripe
...
![WipeStripes](../_static/WipeStripes.jpg)
...
- **Angle** (Default: 45, Range: any)
  The rotation of the overall stripes pattern used for the wipe, in degrees.

- **Frequency** (Default: 6, Range: 0.1 or greater)
  The frequency of the stripes pattern. Increase for more and smaller elements, or decrease for fewer and larger.

- **Shift Stripes** (Default: 0, Range: any)
