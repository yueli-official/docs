...
This registration must be performed from within the plug-in's entry function, using the [Register Suite](../aegp-suites#aegp_registersuites5).
...
They can be simple, just [adding one menu item](../implementation#example-adding-a-menu-item) to trigger an external application, or complex like Artisans.
