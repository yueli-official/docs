...
| | 1. Utilize the [Compute Cache API](../compute-cache-api#compute-cache-api) for thread-safe cache access instead of reading/writing to sequence_data directly.  See [Compute Cache For Multi-Frame Rendering](#compute-cache-for-multi-frame-rendering) for more information. AND / OR |
...
* The Compute Cache API supports both single and multi-checkout computation tasks depending upon the needs of the effect. See the [Compute Cache API](../compute-cache-api#compute-cache-api) documentation for more information.
...
See the [Compute Cache API](../compute-cache-api#compute-cache-api) documentation for implementation details and sample code.
