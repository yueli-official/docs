...
What are these mysterious handles? These opaque data handles can be used with [AEGP_IOInSuite5](../new-kids-on-the-function-block#aegp_ioinsuite5) and [AEGPIOOutSuite4](../new-kids-on-the-function-block#aegpiooutsuite4), to set or query for information about the import or output.
