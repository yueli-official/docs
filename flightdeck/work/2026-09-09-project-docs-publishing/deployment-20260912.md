...
所属仓库：docs。状态：本轮服务器更新完成；不表示本 Work 的正式 SDK 发布等其他门禁完成。

- 固定候选源码 HEAD：`8682d9b0ccf4b8a310c148943bbcf0cf9bb50dd9`；未提交改动通过逐文件 SHA256 与补丁归档，包括 Blog/WWW PAT 和 Foundation 编辑器按钮居中修复。
